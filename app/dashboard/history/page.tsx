...
async function History() {
    ...
    {/* @ts-ignore */}
    const HistoryList:HISTORY[]=await db.select().from(VenkyAIOutput).where(eq(VenkyAIOutput?.createdBy,user?.primaryEmailAddress?.emailAddress))
    .orderBy(desc(VenkyAIOutput.id))
    ;
  ...
  return (
    <div className='m-5 p-5 border rounded-lg bg-white'>
        ...
        <p className='text-gray-500'>Search your previously create AI content</p>
