...
import { UserSubscription, VenkyAIOutput } from '@/utils/schema';
...
import { UpdateCreditUsageContext } from '@/app/(context)/UpdateCreditUsageContext';
 ...
 function UsageTrack() {
    ...
    const GetData=async()=>{
         {/* @ts-ignore */}
        const result:HISTORY[]=await db.select().from(VenkyAIOutput).where(eq(VenkyAIOutput.createdBy,user?.primaryEmailAddress?.emailAddress));
  ...
  return (
    <div className='m-5'>
        <div className='bg-gray-600 text-white p-3 rounded-lg'>
            ...
            <div className='h-2 bg-[rgb(93,129,133)] w-full rounded-full mt-3'>
