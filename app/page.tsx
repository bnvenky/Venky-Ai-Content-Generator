  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
   <div className="mt-5 w-full text-center mx-auto ">
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      ...
      Create amazing content quickly with our AI app, producing engaging and high-quality text in seconds.</p>
    </div>
    ...
    <div className="mt-8 gap-3 flex justify-center">
      ...
      gap-x-3 text-center bg-gradient-to-tl from-blue-600
       to-gray-600 hover:from-gray-700 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:focus:ring-offset-gray-800" 
       href="/dashboard">
        Get started
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
    ...
    <a className="group flex flex-col justify-center  hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      <div className="flex justify-center items-center size-12 bg-blue-400 rounded-xl">
      ...
      <div className="mt-5">
        ...
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Create a responsive, mobile-first project on the web with ease.</p>
    ...
    <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5">
        ...
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Components are easy to customize and extend.</p>
        <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
          Learn more
          <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </span>
    ...
    <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5">
        ...
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Every component and plugin comes with detailed documentation.</p>
        <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
          Learn more
          <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </span>
    ...
    <a className="group flex flex-col justify-center hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5">
        ...
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Contact us anytime, 24/7.</p>
        <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
          Learn more
          <svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </span>
